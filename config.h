...
static const char *fonts[]          = { "MesloLGS Nerd Font:size=14", "Noto Color Emoji:size=14", "NotoSans Nerd Font:size=14" };
static const char dmenufont[]       = "MesloLGS Nerd Font Mono:size=14";
static const char col_gray1[]       = "#1d293d";
static const char col_gray2[]       = "#45556c";
static const char col_gray3[]       = "#90a1b9";
static const char col_gray4[]       = "#e2e8f0";
static const char col_gray5[]       = "#f8fafc";
